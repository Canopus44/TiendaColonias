...
public class Producto {
   ...
   private String imagen;
    ...
    public Producto(int id_Prod, String marca, String nombre_Prd, String referencia, String ano_Inic, String fmlaolfat, String nota_Salida, String nota_Corazon, String nota_Fondo, String categoria, String oferta, String genero, int tipo, int onzas, double precio_Compra, double precio_Venta, double descuento, double precio_Descuento, int stock, String imagen) {
