...
-- Volcando datos para la tabla bd_tienda.maestro_clientes: ~8 rows (aproximadamente)
...
INSERT INTO `maestro_proveedores` (`mp_idproveedor`, `mp_nombreproveedor`, `mp_ciudad`, `mp_departamento`, `mp_codpostal`, `mp_provincia`, `mp_pais`, `mp_numtelefono`, `mp_numfax`, `mp_email`) VALUES
	(1, 'Lociones Hernan LTDA', 'CALI', 'VALLE DEL CAUCA', '10001', NULL, 'COLOMBIA', '31254558', '2252522', 'locionesentregas@gmail.com');
