            ...
            <div class="card col-sm-10">
                <div class="card-body text-center">
                    <form class="form-sing" action="Registrar" method="POST">
                        ...
                        <input type="submit" name="registrar" value="Registrar" class="btn btn-primary btn btn-block">
                        <a type="submit" name="login" value="Regresar" class="btn btn-primary btn btn-block" href="login.jsp">Regresar</a>
                    </form>                    
                </div>
            </div>
        </div>       
